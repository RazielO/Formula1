...
export class Consumer {
    ...
    static async getDriverStandings(season: number, round: number | undefined = undefined): Promise<DriverStanding[]> {
        ...
        if (response.MRData.StandingsTable === undefined || response.MRData.StandingsTable?.StandingsLists.length === 0) {
            return []
        }
    ...
    static async getConstructorStandings(season: number, round: number | undefined = undefined): Promise<ConstructorStanding[]> {
