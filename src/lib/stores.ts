...
export const driverStandings: Writable<{ [key: number]: DriverStanding[] }> = writable({});
export const constructorStandings: Writable<{ [key: number]: ConstructorStanding[] }> = writable({});
